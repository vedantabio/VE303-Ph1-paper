...
median_RA_cohorts45 = subset(VE303_abs_abund, Subject.Cohort==4 | Subject.Cohort==5) %>%
...
subset(Timepoint.Calc=="Day 14" | Timepoint.Calc =="Week 52") %>%
...
auc_l$dose_duration <- factor(auc_l$dose_duration, 
                            levels=c("No VE303", "Single Day", "5 Days", "14 Days", "21 Days"))
